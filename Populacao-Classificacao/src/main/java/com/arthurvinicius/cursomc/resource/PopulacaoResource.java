...
import com.arthurvinicius.cursomc.Dto.ClassificacaoDto;
...
//	}
	...
	public ResponseEntity<List<PopulacaoDto>> findAll() {
		List<Populacao> list = populacaoService.findAll();
		List<PopulacaoDto> listDto = list.parallelStream().map(obj -> new PopulacaoDto())
